...
public class PaymentTerminal {
    ...
    public double eatAffordably(double payment) {
        ...
        // return the change if the payment parameter is not large enough, 
    ...
    public double eatHeartily(double payment) {
        ...
        // increase the amount of cash by the price of a hearty mean and return 
        // the change if the payment parameter is not large enough, no meal is 
        // sold and the method should return the whole payment
